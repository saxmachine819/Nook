...
const { GET } = await import('@/app/api/cron/booking-reminder-60min/route')

describe('GET /api/cron/booking-reminder-60min', () => {
  ...
  it('returns 401 when Authorization header is missing', async () => {
    const request = new Request('http://localhost/api/cron/booking-reminder-60min', {
      method: 'GET',
    })
