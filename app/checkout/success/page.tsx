...
import ClearBookingStateClient from './ClearBookingStateClient'
            ...
            <CardContent className="p-8 sm:p-12 pt-0 space-y-10">
              ...
              <div className="grid gap-6 sm:grid-cols-3">
                <div className="group space-y-3">
                  ...
                  <p className="text-xs text-slate-500 leading-relaxed">
                    Your secure payment has been processed by Stripe.
                  </p>
                </div>
                <div className="group space-y-3">
                  <div className="h-1 w-full bg-emerald-500 rounded-full transition-all group-hover:h-1.5" />
                  ...
                  <p className="text-xs text-slate-500 leading-relaxed">
                    Your selected seat or table is now blocked off just for you.
                  </p>
                </div>
                <div className="group space-y-3">
                  <div className="h-1 w-full bg-emerald-500 rounded-full transition-all group-hover:h-1.5" />
                  ...
                  <p className="text-xs text-slate-500 leading-relaxed">
                    Head to the venue at your booked time and show your digital receipt.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-4 pt-4 sm:flex-row">
                <Button
                  asChild
                  size="lg"
                  className="flex-1 rounded-2xl h-14 text-base font-bold shadow-xl shadow-emerald-500/10 transition-all hover:scale-[1.02]"
                >
                ...
                <Button
                  ...
                  asChild
                  size="lg"
                  className="flex-1 rounded-2xl h-14 text-base font-semibold border-slate-200 hover:bg-slate-50 transition-all"
                >
