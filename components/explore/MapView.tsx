...
export function MapView({
  ...
  if (!hasMapboxToken) {
    return (
      <div className="fixed left-0 right-0 bottom-0 safe-area-top z-0 flex items-center justify-center bg-muted/50">
  ...
  return (
    <div className="fixed left-0 right-0 bottom-0 safe-area-top z-0">
      <MapboxMap
        venues={venues}
