...
- Instant confirmation when availability exists
- Monetization begins with per-booking fees

## Differentiation
- Clarity and confidence around availability and pricing
- Work-first positioning (not dining-first)
...
- Venue analytics and yield tools
- Integrations with POS, property systems, Wi-Fi
...
3. Calm UI.
4. Two-sided empathy.
5. Build rails for the future.

## MVP scope
- Browse venues
- View availability and pricing
- Reserve seats by the hour
- Venue self-serve onboarding
